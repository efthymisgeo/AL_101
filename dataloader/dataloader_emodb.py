...
actlearn_dir = os.path.join(
    os.path.dirname(os.path.realpath(__file__)),
    '../../')
sys.path.insert(0, actlearn_dir)

from AL_101.config import EMOBASE_PATH
from AL_101.dataloader.AudioReader import AudioFile
